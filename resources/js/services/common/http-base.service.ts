...
import { AxiosObservable } from '@/../../../../node_modules/axios-observable/dist/axios-observable.interface';

//import { APISecurityTokenModel } from '../../models/api-security-token-model';
...
export abstract class HTTPBaseService {
  ...
  //protected APISecurityToken: APISecurityTokenModel | any = null;
  ...
  private getHTTPHeaders(): any {
    ...
    if (this.hasAPISecurityToken()) {
        httpHeaders.Authorization = this.APISecurityToken.token_type + ' ' + this.APISecurityToken.access_token;
    }
    */
    return httpHeaders;
  }
